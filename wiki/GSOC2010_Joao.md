...
Coarse-Graining makes use of this function when reducing each residue to
3 points (ENCAD-like): Ca, peptide-bond O, and center of mass of side
chain. The default CG function reduces the protein to a Ca-trace. I am
still working on implementing perhaps some other CG-representations such
as that from CABS.
...
cg_3pt = p.coarse_grain('3pt')

for residue in cg_3pt.get_residues():
