...
-   Source Tarball --
    <http://biopython.open-bio.org/static/DIST/biopython-1.41.tar.gz>
    biopython-1.41.tar.gz\] 3,718 Kb
-   Source Zip File --
    <http://biopython.open-bio.org/static/DIST/biopython-1.41.zip>
    biopython-1.41.zip\] 4,240 Kb
-   Windows Installer for Python 2.3 --
    <http://biopython.open-bio.org/static/DIST/biopython-1.41.win32-py2.3.exe>
    biopython-1.41.win32-py2.3.exe\] 1,038 Kb
-   Windows Installer for Python 2.4 --
    <http://biopython.open-bio.org/static/DIST/biopython-1.41.win32-py2.4.exe>
