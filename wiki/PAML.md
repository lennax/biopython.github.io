...
``` python
from Bio.Phylo.PAML import codeml</python>
...
<source lang=python>
cml = codeml.Codeml(alignment = "align.phylip", tree = "species.tree", out_file = "results.out", working_dir = "./scratch")</python>
...
``` python
 from Bio.Phylo.PAML.chi2 import cdf_chi2</python>
