...
"                            #1st: your fasta file 
"                            #2nd: the user defines the minimum length (default value 0 ( means  you dont care to minimum length)
"                            #3rd: the user defines the % of N is allows (default value 100 ( means  you dont care to 'N' in your sequences))
